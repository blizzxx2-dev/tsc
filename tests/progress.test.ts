...
import { buyUpgrade, CHAPTER_FEE, freshProgress, migrateProgress, RANK_FEE, recordChapter, recordRun, setDifficulty, UPGRADE_TOTAL, UPGRADES, type UpgradeId } from '../src/surgery/progress';
import { Operation } from '../src/surgery/operation';
import { playWithBot } from './bot';
import { at, Hand, running } from './harness';
...
describe('GAM-F/M progression', () => {
  ...
  it('GAM-0233: demo progress (the original v1 save) carries into the full game', () => {
    const v1 = { version: 1, progress: { chapter: 1, step: 3 }, best: { 'op1-1': { rank: 'A', score: 4000 }, 'op2-5': { rank: 'S', score: 7000 } }, volume: 0.5 };
