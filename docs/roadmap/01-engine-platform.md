...
- [x] ENG-0105 · Demo · P0 · L · Malison of Lauds render set — chorister core with orbiting Voices (emissive rings), Hymn ring distortion wave, submerged silhouette visible only through the Scrying Lens, hexstone shatter
...
- [x] ENG-0275 · Alpha · P2 · M · Diagnosis view — full-body chart renderer (patient silhouette with region hover, symptom overlays) reusing sprite/mesh APIs
