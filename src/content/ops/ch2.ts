...
export const OP_2_1 = defineOp({
  ...
  patient: 'Tomas, scout',
  patientGender: 'm',
  diagnosis: 'Mauled by a corpse-eating hound. Grave-dirt in the claw rakes, fangs lodged in the shoulder (one broken), venom spreading from the bite.',
  organ: 'flesh',
  timeLimit: 240,
...
export const OP_2_3 = defineOp({
  ...
  patientGender: 'm',
  race: 'elf',
  diagnosis: 'Two web-spinner bites, a day old. Neurotoxic venom spreading from the neck; several egg sacs laid beneath the skin.',
  organ: 'flesh',
  timeLimit: 240,
  baseDrain: 0.1,
