...
import { BLOOD_DECAL_FS, COVERAGE_FS, COVERAGE_VS, DECAL_UPDATE_FS, DECAL_UPDATE_VS, DECAL_VS, SCORCH_DECAL_FS, STAIN_DECAL_FS, STAMP_FS, STAMP_VS } from './shaders/decal';
...
export function shaderCatalog(): ShaderVariant[] {
  const list: ShaderVariant[] = [
    ...
    { name: 'decal-update', vs: DECAL_UPDATE_VS, fs: DECAL_UPDATE_FS },
    { name: 'decal-stain', vs: DECAL_VS, fs: STAIN_DECAL_FS },
  ];
